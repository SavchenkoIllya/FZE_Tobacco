...
import { FilterLabelContainer, Menu, ProductCard, Search } from "@/app/ui";
import { MenuFiltersProps } from "@/app/ui/sections/Catalogue/components/Catalogue.Section.Wrapper";
import { SliderMenu } from "@/app/ui/sections/Catalogue/components/Slider.Menu";

export function CatalogueSectionView({ menuFilters }: MenuFiltersProps) {
  return (
    <section id={LandingSections.CATALOGUE} className="py-10 w-full bg-white">
      <div className="container mx-auto h-[80dvh]">
        <div className="justify-center md:justify-normal grid grid-cols-4 grid-rows-[auto_1fr] h-full">
          ...
          <div
            className={
              "col-span-4 md:col-span-3 overflow-y-scroll scrollbar-hide"
            }
          >
