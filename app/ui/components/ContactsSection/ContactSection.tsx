...
export const ContactsSection = () => {
  return (
    <section className={"relative flex flex-col justify-center items-center"}>
      <BackgroundImage imageUrl={"/images/Pattern_left.png"} size={{width:"500px", height:"3600px"}} position={{left:"0", bottom:"0"}} />
      <BackgroundImage imageUrl={"/images/Pattern_right.png"} size={{width:"500px", height:"1800px"}} position={{right:"0", bottom:"0"}} />
      ...
      <div className={"flex gap-2"}>
        <div className={"p-8 space-y-4 border-accent border-r-2"}>
          <div className={"flex items-center gap-2"}>
            ...
            <Checkbox checked={true} onChange={()=>{}} label={"Spuntando questa casella ci autorizzi al trattamento dei tuoi dati personali, ne avremo cura."}/>
        </div>
        <div>
          Map is here
        </div>
